...
Set-PSFConfig -Module dbachecks -Name policy.security.scanforstartupproceduresdisabled -Value 0 -Initialize -Description "Remote Access should be disabled 0 or enabled 1"
...
Set-PSFConfig -Module dbachecks -Name skip.instance.scanforstartupproceduresdisabled -Validation bool -Value $false -Initialize -Description "Skip the default trace check"
