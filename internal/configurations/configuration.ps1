...
Set-PSFConfig -Module dbachecks -Name skip.agent.history -Validation bool -Value $false -Initialize -Description "Skip the Agent Job History test (useful when you don't have the job history configured - MaximumHistoryRows = -1)"
