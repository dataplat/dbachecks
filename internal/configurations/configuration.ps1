...
Set-PSFConfig -Module dbachecks -Name policy.autoclose -Validation integer -Value $false -Initialize -Description "Alters the Auto Close check to say if it should be allowed `$true or dissalower `$false"
Set-PSFConfig -Module dbachecks -Name policy.autoshrink -Validation integer -Value $false -Initialize -Description "Alters the Auto Shrink check to say if it should be allowed `$true or dissalower `$false"
