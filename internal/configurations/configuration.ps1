...
Set-PSFConfig -Module dbachecks -Name policy.security.remoteaccessdisabled -Validation bool -Value $true -Initialize -Description "Remote Access should be disabled `$true or enabled `$false"
