...
Set-PSFConfig -Module dbachecks -Name skip.security.windowsauthenticationmode -Validation bool -Value $true -Initialize -Description "Skips the scan for if Windows Authentication Mode is enabled"
