...
Set-PSFConfig -Module dbachecks -Name policy.security.remoteaccess -Validation bool -Value $true -Initialize -Description "Remote Access should be disabled `$true or enabled `$false"
