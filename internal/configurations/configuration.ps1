...
Set-PSFConfig -Module dbachecks -Name skip.security.nonstandardport -Value 0 -Initialize -Description "SQL Server should be configured with a non standard port"
#agent
