...
Set-PSFConfig -Module dbachecks -Name policy.database.querystoreenabledexclude -Value @('msdb', 'tempdb', 'master') -Initialize -Description "A List of databases that we do not want to check for Query store"
